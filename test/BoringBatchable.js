...
describe("BoringBatchable", function () {
  ...
  it("Batch of 2 transfers", async function () {
    await expect(this.contract.batch([
      ...
      .to.emit(this.contract, "Transfer").withArgs(this.alice.address, this.bob.address, 100)
      .to.emit(this.contract, "Transfer").withArgs(this.alice.address, this.carol.address, 200)
  })
