...
describe("BoringMultipleNFT", async function () {
    ...
    describe('safeTransferFrom function', async function () {
        ...
        it ('should  transfers the ownership of an NFT from one address to another address ', async function () {
            ...
            try {
            let transferFromBobToAliceToken1 = await this.contract.functions["safeTransferFrom(address,address,uint256)"](this.bob.address, this.alice.address, 1)
            }
            catch(error) {
            ...
            let transferFromAliceToBobToken0 = await this.contract.functions["safeTransferFrom(address,address,uint256)"](this.alice.address, this.bob.address, 0)
            ...
            const transferFromAliceToBobToken0 = await this.contract.functions["safeTransferFrom(address,address,uint256)"](this.alice.address, this.bob.address, 1)
